...
export const Route = createFileRoute("/change-password")({
  head: () => ({ meta: [{ title: "Change Password — Horizon Academy" }] }),
  component: () => (
    <AuthShell title="Change password" subtitle="Choose a strong password you haven't used elsewhere." footer={<Link to="/app/dashboard" className="text-primary">Back to dashboard</Link>}>
