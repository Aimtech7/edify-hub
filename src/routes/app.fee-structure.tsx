...
export const Route = createFileRoute("/app/fee-structure")({
  head: () => ({ meta: [{ title: "Fee Structure — Horizon Academy" }] }),
  component: () => <RoleGate allowed={["admin", "accountant"]}><FeeStructurePage /></RoleGate>,
});
