...
from .services.exam_bi import get_exam_bi_data
from .services.certificate_bi import get_certificate_bi_data
...
class ExamBIView(APIView):
    permission_classes = [IsAuthenticated]

    def get(self, request):
        return Response(get_exam_bi_data())


class CertificateBIView(APIView):
    permission_classes = [IsAuthenticated]

    def get(self, request):
        return Response(get_certificate_bi_data())
