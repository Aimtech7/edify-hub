...
export const Route = createFileRoute("/forgot-password")({
  head: () => ({ meta: [{ title: "Forgot Password — Horizon Academy" }] }),
  component: () => (
    <AuthShell title="Reset your password" subtitle="We'll send a reset link to your registered email." footer={<Link to="/login/student" className="text-primary">Back to sign in</Link>}>
